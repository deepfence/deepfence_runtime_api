...
if __name__ == '__main__':
    ...
    if len(sys.argv) != 5:
        print(
            "Usage: python3 user_activity.py <mgmt_console_ip_address> <api_key> <timestring_iso_format:from_time> <timestring_iso_format:to_time>")
        # i.e. python3 user_activity.py 167.71.71.71 042c1cd3-0fcc-40e5-8f74-6e6c1d3eca92 "2023-01-31T00:00:00+05:30" "2023-02-06T00:00:00+05:30"
        exit(1)
    user_audit_logs = user_activity_log("https://{0}/deepfence/v1.5".format(sys.argv[1]), sys.argv[2], sys.argv[3],
                                        sys.argv[4])
