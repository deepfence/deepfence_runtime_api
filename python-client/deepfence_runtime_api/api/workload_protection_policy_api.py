...
class WorkloadProtectionPolicyApi(object):
    ...
    def add_workload_protection_policy_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/deepfence/v1.3/users/node_network_protection_policy', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def bulk_delete_workload_protection_policy_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/deepfence/v1.3/users/node_network_protection_policy', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_workload_protection_policy_with_http_info(self, policy_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/deepfence/v1.3/users/node_network_protection_policy/{policy_id}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_workload_protection_policy_with_http_info(self, node_policy_type, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/deepfence/v1.3/users/node_network_protection_policy', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
