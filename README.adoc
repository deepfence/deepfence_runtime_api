...
|**filters** +
__optional__||<<_deepfencev1_5alerts_filters,deepfencev1.5alerts_filters>>
|**size** +
...
**Default** : `"get"`|enum (get, delete)
|**filters** +
__optional__||<<_deepfencev1_5compliancescan_results_filters,deepfencev1.5compliancescan_results_filters>>
|**size** +
...
|Name|Description|Schema
|**filters** +
__optional__||<<_deepfencev1_5enumerate_filters,deepfencev1.5enumerate_filters>>
|**size** +
...
**Default** : `"get"`|enum (get, delete)
|**filters** +
__optional__||<<_deepfencev1_5usersnetwork_protection_policy_log_filters,deepfencev1.5usersnetwork_protection_policy_log_filters>>
|**size** +
...
**Default** : `"get"`|enum (get, delete)
|**filters** +
__optional__||<<_deepfencev1_5usersquarantine_protection_policy_log_filters,deepfencev1.5usersquarantine_protection_policy_log_filters>>
|**size** +
__optional__|The numbers of policy logs to return +
**Minimum value** : `1` +
**Maximum value** : `10000` +
...
**Default** : `"get"`|enum (get, delete)
|**filters** +
__optional__||<<_deepfencev1_5vulnerability_filters,deepfencev1.5vulnerability_filters>>
|**size** +
__optional__|The numbers of vulnerabilities to return +
**Minimum value** : `1` +
**Maximum value** : `10000` +
...
[[_deepfencev1_5alerts_filters]]
=== deepfencev1.5alerts_filters
...
[[_deepfencev1_5compliancescan_results_filters]]
=== deepfencev1.5compliancescan_results_filters
...
[[_deepfencev1_5enumerate_filters]]
=== deepfencev1.5enumerate_filters
...
[[_deepfencev1_5usersnetwork_protection_policy_log_filters]]
=== deepfencev1.5usersnetwork_protection_policy_log_filters
...
[[_deepfencev1_5usersquarantine_protection_policy_log_filters]]
=== deepfencev1.5usersquarantine_protection_policy_log_filters
Filter policy logs by various fields (key value pairs)
...
[[_deepfencev1_5vulnerability_filters]]
=== deepfencev1.5vulnerability_filters
Filter vulnerabilities by various fields (key value pairs)
